...
Widget header = const Padding(
  ...
  child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
    Image(
        width: 60,
        height: 60,
        image: AssetImage('assets/images/fundraisers_icon.png')),
    SizedBox(width: 15),
    Expanded(
      child: Column(
...
class FundraiserCategory extends StatelessWidget {
  const FundraiserCategory({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i < articleContents.length; i++) {
      if (articleContents[i].category == 'fundraisers') {
